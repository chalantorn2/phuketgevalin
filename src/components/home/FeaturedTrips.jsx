        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-primary-500 font-bold tracking-widest uppercase text-xs">Recommended Trips</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-4">
              ทริปวันเดียว <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-primary-300">เที่ยวสุดคุ้ม</span>
            </h2>
