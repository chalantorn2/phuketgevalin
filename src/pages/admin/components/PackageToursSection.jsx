      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage multi-day tour packages
          </p>
        </div>
        <button
          onClick={() => {
              ...
              {tours.length > 0 ? (
                    ...
                    <td className="py-4 px-6">
                      <div>
                        <div className="font-medium">
                          ฿{Math.floor(Number(tour.price)).toLocaleString()}
                        </div>
                        {tour.discount_price && (
                ...
                <tr>
                  <td colSpan="7" className="py-12 text-center text-gray-500">
                    No package tours found. Click "Add Package Tour" to create
                    one.
                  </td>
                </tr>
              )}
...
function DynamicListInput({
  ...
  const colorClasses = {
    blue: {
      ...
      remove: "text-blue-400 hover:text-red-500",
    },
    orange: {
      btn: "bg-orange-500 hover:bg-orange-600",
      remove: "text-orange-400 hover:text-red-500",
    },
  };
...
const ThaiFlag = () => (
  <svg
    className="w-5 h-3 rounded shadow-sm flex-shrink-0"
    viewBox="0 0 28 20"
    fill="none"
  >
...
function PackageTourForm({ tour, onClose, onSave }) {
  ...
  const [formData, setFormData] = useState({
    ...
    discount_price: tour?.discount_price
      ? Math.floor(Number(tour.discount_price))
      : "",
    image: tour?.image || "",
  ...
  const updateItineraryMeal = (index, mealKey, value) => {
    setFormData((prev) => ({
      ...
      itinerary: prev.itinerary.map((item, i) =>
        i === index
          ? { ...item, meals: { ...item.meals, [mealKey]: value } }
          : item,
      ),
    }));
  };
    ...
    <div className="bg-white rounded-xl shadow-sm flex flex-col max-h-[90vh]">
      ...
      <div className="flex justify-between items-center p-4 border-b flex-shrink-0">
        <h4 className="text-lg font-semibold">
          {tour ? "Edit Package Tour" : "Add New Package Tour"}
        </h4>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Upload multiple images. First image = Cover. Drag to reorder.
                </p>
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                <h5 className="font-medium text-gray-800 mb-3">
                  Pricing & Duration / ราคาและระยะเวลา
                </h5>
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="2 วัน 1 คืน">2 วัน 1 คืน</option>
                      <option value="3 วัน 2 คืน">3 วัน 2 คืน</option>
                      <option value="4 วัน 3 คืน">4 วัน 3 คืน</option>
                      <option value="5 วัน 4 คืน">5 วัน 4 คืน</option>
                      <option value="6 วัน 5 คืน">6 วัน 5 คืน</option>
                      <option value="7 วัน 6 คืน">7 วัน 6 คืน</option>
                      <option value="8 วัน 7 คืน">8 วัน 7 คืน</option>
                      <option value="9 วัน 8 คืน">9 วัน 8 คืน</option>
                      <option value="10 วัน 9 คืน">10 วัน 9 คืน</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("highlights_en", index, value)
                    }
                  ...
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("highlights_th", index, value)
                    }
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            <label
                              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border cursor-pointer ${item.meals?.b ? "bg-orange-50 text-orange-600 border-orange-200" : "bg-gray-50 text-gray-400 border-gray-200"}`}
                            >
                              <input
                                type="checkbox"
                            ...
                            <label
                              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border cursor-pointer ${item.meals?.l ? "bg-green-50 text-green-600 border-green-200" : "bg-gray-50 text-gray-400 border-gray-200"}`}
                            >
                              <input
                                type="checkbox"
                            ...
                            <label
                              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border cursor-pointer ${item.meals?.d ? "bg-indigo-50 text-indigo-600 border-indigo-200" : "bg-gray-50 text-gray-400 border-gray-200"}`}
                            >
                              <input
                                type="checkbox"
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updateItineraryMeal(index, "note", e.target.value)
                            }
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("included_en", index, value)
                    }
                  ...
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("included_th", index, value)
                    }
              ...
              <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("excluded_en", index, value)
                    }
                  ...
                  <DynamicListInput
                    ...
                    onUpdate={(index, value) =>
                      updateListItem("excluded_th", index, value)
                    }
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          meeting_point_en: e.target.value,
                        })
                      }
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          meeting_point_th: e.target.value,
                        })
                      }
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          important_info_en: e.target.value,
                        })
                      }
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                      rows="3"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          important_info_th: e.target.value,
                        })
                      }
                      className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
                      rows="3"
