...
export const packageToursAPI = {
  ...
  create: (data) =>
    fetchAPI("package_tours", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`package_tours?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const hotelRoomTypesAPI = {
  getByHotel: (hotelId, showAll = false) =>
    fetchAPI(
      `hotel_room_types?hotel_id=${hotelId}${showAll ? "&all=true" : ""}`,
    ),
  getById: (id) => fetchAPI(`hotel_room_types?id=${id}`),
  create: (data) =>
    fetchAPI("hotel_room_types", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`hotel_room_types?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const hotelPeriodsAPI = {
  getByHotel: (hotelId, showAll = false) =>
    fetchAPI(`hotel_periods?hotel_id=${hotelId}${showAll ? "&all=true" : ""}`),
  getById: (id) => fetchAPI(`hotel_periods?id=${id}`),
  create: (data) =>
    fetchAPI("hotel_periods", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`hotel_periods?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const hotelRoomPricesAPI = {
  ...
  create: (data) =>
    fetchAPI("hotel_room_prices", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`hotel_room_prices?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const transferLocationsAPI = {
  getAll: (showAll = false) =>
    fetchAPI(`transfer_locations${showAll ? "?all=true" : ""}`),
  getById: (id) => fetchAPI(`transfer_locations?id=${id}`),
  create: (data) =>
    fetchAPI("transfer_locations", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`transfer_locations?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const transferRoutesAPI = {
  getAll: (showAll = false) =>
    fetchAPI(`transfer_routes${showAll ? "?all=true" : ""}`),
  getById: (id) => fetchAPI(`transfer_routes?id=${id}`),
  getByLocations: (fromId, toId) =>
    fetchAPI(`transfer_routes?from=${fromId}&to=${toId}`),
  create: (data) =>
    fetchAPI("transfer_routes", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`transfer_routes?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const promotionsAPI = {
  getAll: (showAll = false) =>
    fetchAPI(`promotions${showAll ? "?all=true" : ""}`),
...
export const onedayTripsAPI = {
  ...
  create: (data) =>
    fetchAPI("oneday_trips", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (id, data) =>
    fetchAPI(`oneday_trips?id=${id}`, {
      method: "PUT",
      body: JSON.stringify(data),
    }),
  delete: (id) =>
...
export const adminAPI = {
  ...
  getBookings: (status = "") =>
    fetchAPI(
      `admin?action=bookings${status && status !== "all" ? `&status=${status}` : ""}`,
    ),
